...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "20250512.1"
  WORKING_DIRECTORY "/home/kinetic/project/mprpc/thirdparty/protobuf/build/_deps/absl-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/kinetic/project/mprpc/thirdparty/protobuf/build/_deps/absl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/kinetic/project/mprpc/thirdparty/protobuf/build/_deps/absl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
